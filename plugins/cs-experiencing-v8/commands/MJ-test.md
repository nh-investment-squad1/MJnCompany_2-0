---
description: "14-agent AI Teams web testing - runs the MJ-test domain protocol from cs-experiencing-v1"
...
```
/MJ-test https://example.com
/MJ-test https://example.com --skip-build
```

## 실행

이 커맨드는 `MJ-test-v1/skills/MJ-test/SKILL.md` 프로토콜을 실행합니다.
(MJ-test-v1은 cs-experiencing-v1과 같은 레벨의 plugins/ 디렉토리에 위치)

URL을 대상으로 14-agent 팀을 가동하세요:
1. `../MJ-test-v1/VERSION` 읽기 → 현재 버전 확인
2. `../MJ-test-v1/skills/MJ-test/SKILL.md` 프로토콜 실행
