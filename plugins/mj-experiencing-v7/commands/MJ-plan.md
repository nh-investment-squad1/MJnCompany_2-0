---
description: "TDD + Clean Architecture 4-agent planning - runs the MJ-plan domain protocol from mj-experiencing-v1"
...
이 커맨드는 `MJ-plan-v1/skills/MJ-plan/SKILL.md` 프로토콜을 실행합니다.
(MJ-plan-v1은 mj-experiencing-v1과 같은 레벨의 plugins/ 디렉토리에 위치)

1. `../MJ-plan-v1/VERSION` 읽기 → 현재 버전 확인
2. `../MJ-plan-v1/skills/MJ-plan/SKILL.md` 프로토콜 실행
