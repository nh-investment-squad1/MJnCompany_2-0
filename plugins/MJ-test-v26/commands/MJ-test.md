---
description: "MJ-test 도메인 웹 테스트 실행 - 14개 AI 에이전트 팀 (playwright-test-v5 기반)"
...
MJ-test 도메인의 14-agent AI Teams 웹 테스트를 실행합니다.

## 사용법

```
/MJ-test https://example.com
/MJ-test http://localhost:3000
```
...
MJ-test-v1 (VERSION 파일 참조: `domains/MJ-test-v1/VERSION`)

## 실행

`domains/MJ-test-v1/skills/MJ-test/SKILL.md` 프로토콜을 따릅니다.
