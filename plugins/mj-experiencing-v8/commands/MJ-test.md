---
description: "14-agent AI Teams web testing - runs the MJ-test domain protocol from mj-experiencing-v1"
...
(MJ-test-v1은 mj-experiencing-v1과 같은 레벨의 plugins/ 디렉토리에 위치)
