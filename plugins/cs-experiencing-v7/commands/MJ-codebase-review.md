...
# /MJ-codebase-review [path] [--focus aspect]
...
```
/MJ-codebase-review                          # 전체 코드베이스 분석
/MJ-codebase-review src/                     # 특정 경로만 분석
/MJ-codebase-review --focus security         # 보안 관점만 분석
/MJ-codebase-review --focus architecture     # 아키텍처 관점만 분석
```

## 실행

이 커맨드는 `MJ-codebase-review-v1/skills/MJ-codebase-review/SKILL.md` 프로토콜을 실행합니다.
(MJ-codebase-review-v1은 cs-experiencing-v1과 같은 레벨의 plugins/ 디렉토리에 위치)

1. `../MJ-codebase-review-v1/VERSION` 읽기 → 현재 버전 확인
2. `../MJ-codebase-review-v1/skills/MJ-codebase-review/SKILL.md` 프로토콜 실행
