---
description: "TDD + Clean Architecture 4-agent planning - runs the MJ-plan domain protocol from cs-experiencing-v1"
...
(MJ-plan-v1은 cs-experiencing-v1과 같은 레벨의 plugins/ 디렉토리에 위치)
