---
description: "PR 전 최종 검증 게이트 — 스펙 준수·커버리지·커밋 품질 검사 (/mj-ship [path])"
...
| 커맨드 | 설명 |
|--------|------|
| `/mj-ship` | 현재 디렉토리 전체 검증 |
| `/mj-ship [path]` | 지정 경로 검증 |
| `/mj-ship --fix` | 발견된 이슈 자동 수정 활성화 |
