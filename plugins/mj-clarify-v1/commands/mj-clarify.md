---
description: "요구사항 명료화 — 플랜/구현 전 숨겨진 가정과 범위를 명확히 함 (/mj-clarify [요청 설명])"
...
| 커맨드 | 설명 |
|--------|------|
| `/mj-clarify "[요청]"` | 전체 명료화 분석 (4-agent) |
| `/mj-clarify --quick "[요청]"` | 빠른 명료화 (3문항 인터뷰만) |
