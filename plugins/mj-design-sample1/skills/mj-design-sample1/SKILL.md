...
# mj-design-sample1 — Crextio-Inspired Design Guide
...
```bash
/mj-design-sample1                        # 디자인 가이드 전체 출력
/mj-design-sample1 --audit [file]         # 파일이 가이드를 따르는지 검사
/mj-design-sample1 --apply [file]         # 파일에 디자인 가이드 적용
```
